...
def neck(ecken, size):
  t.begin_fill()
  innenwinkel=(ecken-2)*180
  for i in range (ecken):
    t.fd(size)
    t.lt(180-(innenwinkel/ecken))
  t.end_fill()
#----------------------------------------------------------------------------------
...
if w_i == "Ja" or w_i == "ja":
	width_pen = int(input("Wie groß soll der Stift sein?: "))
	t.width(width_pen)
...
elif x== "regelmäßiges n-Eck":
  l = float(input("Wähle eine Seitenlänge: "))
  e = int(input("Wähle eine Ecken-Anzahl: "))
  neck(e,l)
elif x == "Dreieck":
